...
export const UploadIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 16.5V9.75m0 0 3.75 3.75M12 9.75 8.25 13.5m-3-6.062a4.5 4.5 0 0 1 7.5-3.838 5.25 5.25 0 0 1 9.625 2.188c.32.744.5 1.56.5 2.437A5.25 5.25 0 0 1 18 18.75H6a4.5 4.5 0 0 1-3.75-6.062Z" />
    </svg>
);
...
export const WandIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 0 0-5.78 1.128 2.25 2.25 0 0 1-2.475 2.118 2.25 2.25 0 0 1-2.475-2.118c0-.497.158-.958.433-1.343a3 3 0 0 0 5.78-1.128 2.25 2.25 0 0 1 2.475-2.118 2.25 2.25 0 0 1 2.475 2.118c0 .497-.158.958-.433-1.343Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.362 15.125a3 3 0 0 1-5.78-1.128 2.25 2.25 0 0 0-2.475-2.118 2.25 2.25 0 0 0-2.475 2.118c0 .497.158.958.433 1.343a3 3 0 0 1 5.78 1.128 2.25 2.25 0 0 0 2.475 2.118 2.25 2.25 0 0 0 2.475-2.118c0-.497-.158.958-.433-1.343Z" />
  </svg>
);

export const PhotoIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0L21 18.75m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Z" />
  </svg>
);
...
export const SaveIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M17.593 3.322c.1.128.2.27.2.428V21L12 17.25 6.207 21V3.75c0-.158.1-.3.2-.428.344-.434.945-.434 1.289 0l4.212 5.158.09.11.09-.11 4.212-5.158c.344-.434.945-.434 1.289 0Z" />
    </svg>
);
